      ...
      <section id="services">
        <div class="container">
          <div class="section-header">
            ...
            <p>Whether renting a car for your business enterprise or vacation, CarRental has a wide range of luxury, sports, and hybrid vehicles available to meet every car rental need. Take your pick of a Porsche, Ferrari, Lamborghini, Aston Martin, Tesla and more. Check out our entire range of CarRental Gallary (special range of cars) and reserve your model. Enhance your driving plan with CarRental navigation and let begin your roadtrip.</p>
          </div>
    ...
    <!--==========================
      ...
      <section id="clients" class="wow fadeInUp">
        <div class="container">
          <div class="section-header">
            <h2>Clients</h2>
            <p>There are the Clients Below: </p>
          </div>
